...
export const Formats: FormatList = [
	...
	},
	{
		...
		mod: 'gen9',
		ruleset: ['HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Team Preview', 'Max Team Size = 6', 'Max Move Count = 24', 'Max Level = 100', 'Default Level = 100', 'EV Limits = Hp 0-252 / Atk 0-252 / Def 0-252 / Spa 0-252 / Spd 0-252 / Spe 0-252'],
	},
	{
		name: "[Gen 9] Pure Hackmons (doubles)",
		mod: 'gen9',
		gameType: "doubles",
		ruleset: ["Gen 9 Pure Hackmons"],
	},
	{
		name: "[Gen 9] Pure Hackmons (triples)",
		mod: 'gen9',
		gameType: "triples",
		ruleset: ["Gen 9 Pure Hackmons"],
	},
	{
		name: "[Gen 9] Pure Hackmons (multi-battle)",
		mod: 'gen9',
		gameType: "multi",
		ruleset: ["Gen 9 Pure Hackmons"],
	},
	{
		name: "[Gen 9] Pure Hackmons (battle-royale)",
		mod: 'gen9',
		gameType: "freeforall",
		ruleset: ["Gen 9 Pure Hackmons"],
	},
	...
	},
	{
		...
		'Legend Plate', 'Toxeon', 'Zubite', 'Ekansite', 'King Clawthorne', 'The Rizzard of Oz'],
	},
	{
		name: "[Gen 9] Custom Only (doubles)",
		mod: 'gen9',
		gameType: 'doubles',
		ruleset: ['Gen 9 Custom Only'],
	},
	{
		name: "[Gen 9] Custom Only (triples)",
		mod: 'gen9',
		gameType: 'triples',
		ruleset: ['Gen 9 Custom Only'],
	},
	{
		name: "[Gen 9] Custom Only (multi-battle)",
		mod: 'gen9',
		gameType: 'multi',
		ruleset: ['Gen 9 Custom Only'],
	},
	{
		name: "[Gen 9] Custom Only (battle-royale)",
		mod: 'gen9',
		gameType: 'freeforall',
		ruleset: ['Gen 9 Custom Only'],
	},
	{
		section: "NatDex Almost Anything Goes",
	},
	{
		...
		'Zubite', 'Ekansite', 'King Clawthorne', 'The Rizzard of Oz'],
	},
	{
	...
	{
		name: "[Gen 9] NatDex AAG (triples)",
		mod: 'gen9',
		gameType: 'triples',
		ruleset: ['Gen 9 NatDex AAG'],
	},
	{
		name: "[Gen 9] NatDex AAG (multi-battle)",
		mod: 'gen9',
		gameType: 'multi',
		ruleset: ['Gen 9 NatDex AAG'],
	},
	{
		name: "[Gen 9] NatDex AAG (battle-royale)",
		mod: 'gen9',
		gameType: 'freeforall',
		ruleset: ['Gen 9 NatDex AAG'],
	},
	...
	{
		name: "[Gen 9] Starters Only",
		mod: 'gen9',
		ruleset: ['Standard NatDex', 'Species Clause', 'Picked Team Size = 3', 'Max Team Size = 4', '+ Eevium Z', 'Sleep Clause Mod',
		'+ Bulbasaur', '+ Charmander', '+ Squirtle', '+ Pikachu', '+ Eevee', '+ Chikorita', '+ Cyndaquil', '+ Totodile',
	...
	{
		name: "[Gen 9] Starters Only (doubles)",
		mod: 'gen9',
		gameType: 'doubles',
		ruleset: ['Gen 9 Starters Only'],
	},
	{
		name: "[Gen 9] Starters Only (triples)",
		mod: 'gen9',
		gameType: 'triples',
		ruleset: ['Gen 9 Starters Only'],
	},
	{
		name: "[Gen 9] Starters Only (multi-battle)",
		mod: 'gen9',
		gameType: 'multi',
		ruleset: ['Gen 9 Starters Only', '!! Picked Team Size = 2'],
	},
	{
		name: "[Gen 9] Starters Only (battle-royale)",
		mod: 'gen9',
		gameType: 'freeforall',
		ruleset: ['Gen 9 Starters Only', '!! Picked Team Size = 2'],
	},
